...
Planning estimate: **2–3 weeks per POC; 14–21 weeks total**, sequential delivery. Week 1 begins at the agreed kickoff; calendar dates are not yet set. Estimates include implementation and validation, assume continuous capacity and ready test inputs, and are not release commitments. POC 1 includes M1–M3.

| POC | Duration | 2-week schedule | 3-week schedule | Delivery scope |
| --- | --- | --- | --- | --- |
...
## POC 1 — Agent creation and daily syslog automation

**Duration:** 2–3 weeks.

- M1: produce a manual syslog report with source evidence.
- M2: refine, save and reuse the agent after restart.
- M3: schedule daily execution and inspect actual outcomes.

**Default agent / entry:** Daily Syslog Summary Agent.

**Demo:** Create, run, refine, save, and schedule a syslog report.

**Acceptance:** Complete M1–M3 with live NIMBL data, evidence-backed outputs, and truthful failures.

**Feature pages:** [Ask nimbls](../ask-nimbls.html), [Custom Agents](../custom-agents.html), [Scheduling](../automation.html).

## POC 2 — Site history retention and incident investigation
...
## POC 3 — Local model integration and general tasks
...
## POC 4 — Report search, interaction and archiving
...
## POC 5 — Agent performance review and improvement
...
## POC 6 — Controlled external model assistance
...
## POC 7 — Authorized device changes and verification
...
- POC 1 is 2–3 weeks for M1–M3 combined, not per milestone.
- Start the next POC after acceptance. Shorter stages advance subsequent work.
- Estimates assume continuous capacity, ready models/devices/data, and no additional scope. Delays may extend the range.
- Default agents start in POC 1. Basic outputs and execution controls are included there.
