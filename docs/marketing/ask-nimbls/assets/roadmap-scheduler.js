(function (root) {
  ...
  function totalSvg(plan, names, calendar) {
    ...
    let s = '<svg xmlns="http://www.w3.org/2000/svg" width="1400" height="750" viewBox="0 0 1400 750" role="img" aria-labelledby="total-schedule-title"><title id="total-schedule-title">Taiwan working-day POC schedule</title><rect width="1400" height="750" fill="white"/><g font-family="Arial,sans-serif" fill="#191919">';
